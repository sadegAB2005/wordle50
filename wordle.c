    ...
    for (int i = 0; i < guesses; i++)
    {
        ...
        int status[wordsize];
            for (int j = 0; j < wordsize; j++)
                {
                    status[j] = 0;  // Set each element to 0
                }
...

{
    ...
    do
    {
        ...
        // Check if the length of the input word is equal to wordsize
...
int check_word(string guess, int wordsize, int status[], string choice)
{
    ...
    for (int j = 0; j < wordsize; j++)
    {
        ...
        else
        {
            ...
            {
                if (guess[j] == choice[i] && status[i] != EXACT)
                {
                    status[j] = CLOSE;
                    score += CLOSE;
                    break;
